...
PERMISSION_CATALOG = [
    ...
    {"key": "dashboard_projetos", "label": "Dashboard de Projetos", "group": "Dashboards", "actions": ["view"]},
    {"key": "dashboard_glosas", "label": "Dashboard de Glosas", "group": "Dashboards", "actions": ["view"]},
    {"key": "admissoes", "label": "Vagas e admissões", "group": "Operação", "actions": ["view", "create", "edit"]},
    {"key": "colaboradores", "label": "Colaboradores", "group": "RH", "actions": ["view", "edit"]},
    {"key": "controle_rescisoes", "label": "Controle de Rescisões", "group": "Operação", "actions": ["view", "create", "edit"]},
    {"key": "controle_ferias", "label": "Controle de Férias", "group": "Operação", "actions": ["view", "create", "edit"]},
    ...
    {"key": "dashboard_ql", "label": "Dashboard de QL", "group": "Dashboards", "actions": ["view"]},
    ...
    {"key": "controle_dre", "label": "Controle DRE", "group": "Operação", "actions": ["view", "create", "edit"]},
]
...
def request_permission(path, method):
    ...
    rules = [
        ...
        ("/rescisoes/importar", "controle_rescisoes", {"POST": "create"}),
        ("/rescisoes/calcular", "controle_rescisoes", {"POST": "view"}),
        ("/rescisoes", "controle_rescisoes", {"GET": "view", "DELETE": "edit"}),
        ("/ferias/importar", "controle_ferias", {"POST": "create"}),
        ("/ferias/export", "controle_ferias", {"GET": "view"}),
        ("/ferias", "controle_ferias", {"GET": "view", "POST": "edit", "PATCH": "edit", "DELETE": "edit"}),
        ...
        ("/funcionarios", "colaboradores", {"GET": "view", "PATCH": "edit"}),
        ...
        ("/dre", "controle_dre", {"GET": "view", "POST": "create", "PATCH": "edit", "DELETE": "edit"}),
    ]
